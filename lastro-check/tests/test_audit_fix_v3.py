...
from lastro.runtime.adapters import EvidenceLicenseVerifier, EvidencePaymentVerifier, ExternalCommandLicenseVerifier, ExternalCommandPaymentVerifier, InMemoryPaymentReferenceStore
from lastro.runtime.distribution import UnsafeDistributionError, assert_distribution_safe
from lastro.runtime.domain import LicenseEvidence, OfferPolicy, OrderRecord, PaymentEvidence
from lastro.runtime.fulfillment import MINIMUM_SUPPORTED_ENGINE_VERSION, build_receipt, collect_artifacts, verify_receipt, verify_receipt_for_order, write_receipt
...
class AuditFixV3Tests(unittest.TestCase):
    ...
    def test_engine_release_floor_rejects_prerelease_and_accepts_final_or_build_metadata(self):
        from lastro.runtime.fulfillment import _supported_engine_version
